...
Once the runtime starts, you can access the project at [http://localhost:8080/jakartaee-taller3](http://localhost:8080/jakartaee-taller3).
...
```
./mvnw clean package
docker build -t jakartaee-taller3:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 jakartaee-taller3:v1
```
